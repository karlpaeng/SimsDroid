...
public class OrderDetailsActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseHelper databaseHelper = new DatabaseHelper(OrderDetailsActivity2.this);
...
//        showProductOnListView(databaseHelper);
        ...
        ArrayAdapter orderArrayAdapter = new ArrayAdapter<String>(OrderDetailsActivity2.this, android.R.layout.simple_list_item_1, list);
